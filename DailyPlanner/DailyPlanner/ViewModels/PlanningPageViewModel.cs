...
{
    public class PlanningPageViewModel : NavigableViewModel, INavigatedAware
    {
        INavigationService navigationService;
        IRepository repository;
        IPageDialogService dialogService;
        IEventAggregator eventAggregator;
        public PlanningPageViewModel(INavigationService _navigationService, IRepository _repository, IPageDialogService _dialogService, IEventAggregator _eventAggregator)
            :base(_repository)
        {
        ...
        private void BindCommands()
        {
            AddPlanning = new DelegateCommand(async () =>
            {
                ...
                var a = await navigationService.NavigateAsync("PlanningTruckDriverSelectionPage", nParameters);
            });
